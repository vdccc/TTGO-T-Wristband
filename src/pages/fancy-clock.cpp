#include "pages/page-fancy-clock.hpp"
#include "NotoSansBold15.h"

TFT_eSprite face = TFT_eSprite(&tft);

#define CLOCK_X_POS 80
#define CLOCK_Y_POS 40
...
#define CLOCK_R       32.0f // Clock face radius (float type)
...
void renderFace(float h, float m, float s);

// =========================================================================
// Setup
// =========================================================================
void fancyClockSetup() {
  Serial.begin(115200);
  ...
  RTC_Date date = getClockTime();
  renderFace(date.hour, date.minute, date.second);
}

// =========================================================================
// Loop
// =========================================================================
void pageFancyClock(bool firstRun) {
  if (firstRun)
    fancyClockSetup();
  RTC_Date date = getClockTime();
  renderFace(date.hour, date.minute, date.second);
...
// =========================================================================
void renderFace(float h, float m, float s) {
  float h_angle = h * HOUR_ANGLE;
  float m_angle = m * MINUTE_ANGLE;
  float s_angle = s * SECOND_ANGLE;
